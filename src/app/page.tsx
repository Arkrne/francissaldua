...
export default function Home() {
  return (
      ...
      <div id="home">
        ...
        {/* SERVICES SECTION */}
        <section className="relative mx-auto w-full max-w-7xl px-4 py-4 md:px-8 md:py-16 lg:px-16 lg:py-24 reveal" data-reveal>
          <AuroraBackground />
        ...
        {/* PROJECTS SECTION */}
        <section className="mx-auto w-full px-4 py-8 md:px-8 md:py-16 lg:px-16 lg:py-24 reveal" data-reveal>
          <div className="mb-8 md:mb-16 flex flex-col items-center text-center max-w-7xl mx-auto">
        ...
        {/* TECH STACK SECTION */}
        <section className="relative mx-auto w-full py-8 md:py-16 lg:py-24 reveal overflow-hidden" data-reveal>
        ...
        {/* ABOUT SECTION */}
        <section className="w-full py-10 md:py-24 reveal relative overflow-hidden" data-reveal>
          <AboutHyperspeed />
        ...
        <section className="relative overflow-hidden py-8 md:py-16 lg:py-24 reveal" data-reveal>
        ...
        {/* FAQ SECTION */}
        <section className="relative mx-auto w-full max-w-7xl px-4 py-10 md:px-8 md:py-20 lg:px-16 lg:py-24 reveal overflow-hidden" data-reveal>
          <MorphingGradient />
          <div className="relative z-10 grid gap-8 md:gap-12 lg:grid-cols-[1fr_0.85fr] lg:items-center">
