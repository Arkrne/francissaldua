...
export function ContactSection() {
  ...
  return (
    <section className="mx-auto w-full max-w-7xl px-4 py-10 md:px-8 md:py-20 lg:px-16 lg:py-24 relative overflow-hidden">
      <div className="relative overflow-hidden rounded-[2.5rem] border border-[#1d6b6b]/30 bg-[#080d12]/80 p-6 shadow-[0_0_50px_rgba(29,107,107,0.1)] backdrop-blur-xl md:p-10 lg:p-16">
        ...
        {/* Mobile: shrunk into the top-right corner and faded so it never covers the heading/text. */}
        {/* Laptop (md+): restored to the original full-size top-right corner accent. */}
        <div className="absolute top-0 right-0 p-8 pointer-events-none origin-top-right scale-[0.4] -translate-y-4 translate-x-10 opacity-[0.05] md:scale-100 md:translate-x-0 md:translate-y-0 md:opacity-10">
