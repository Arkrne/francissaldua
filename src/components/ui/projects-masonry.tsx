      ...
      >
        ...
        >
          ...
          <div className="relative aspect-[16/10] overflow-hidden">
            ...
            >
              <div className="bg-[#080d12]/85 backdrop-blur-lg border border-[#1d6b6b]/40 rounded-lg p-2.5 md:p-4">
...
const ProjectsMasonry = () => {
  ...
  return (
    <div ref={sectionRef} className="w-full py-10 md:py-24 overflow-hidden">
      <div className="w-full max-w-[1400px] mx-auto px-4 md:px-6">
        ...
        {/* Grid */}
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6 max-md:[&>*:last-child:nth-child(odd)]:col-span-2 max-md:[&>*:last-child:nth-child(odd)]:mx-auto max-md:[&>*:last-child:nth-child(odd)]:w-[calc(50%-0.375rem)]">
