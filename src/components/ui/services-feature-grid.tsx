...
function CyberCard({
  ...
  return (
    ...
    >
      ...
      {/* Card body */}
      <div className="relative h-full rounded-2xl border border-white/[0.06] bg-[#0a1018]/80 backdrop-blur-xl p-4 md:p-8 overflow-hidden transition-all duration-500 group-hover:border-white/[0.12] group-hover:bg-[#0c1420]/90">
        {/* Corner accents */}
        <div
        ...
        <motion.div
          ...
          className="relative inline-flex items-center justify-center w-9 h-9 md:w-12 md:h-12 rounded-lg mb-4 md:mb-6 border transition-all duration-500"
          style={{
        ...
        {/* Title */}
        <h3
          className="text-sm md:text-xl font-bold mb-2 md:mb-3 tracking-tight transition-colors duration-500 text-white group-hover:drop-shadow-[0_0_8px_var(--card-accent)]"
        ...
        {/* HUD label */}
        <div
          className="inline-block mb-2 md:mb-4 font-mono text-[10px] uppercase tracking-[0.3em] opacity-50 group-hover:opacity-80 transition-opacity duration-500"
          style={{ color: feature.accent }}
        >
        ...
        {/* Description */}
        <p className="text-xs md:text-[15px] leading-relaxed text-[#8a9ba8] group-hover:text-[#b0c4d4] transition-colors duration-500">
          {feature.description}
        </p>
        ...
        <motion.div
          ...
          className="mt-3 md:mt-6 flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-2 group-hover:translate-y-0"
        >
          <div
...
export default function ServicesFeatureGrid() {
  ...
  return (
    <section className="py-10 md:py-40 relative z-10">
      <div className="mx-auto w-full px-4 sm:px-6 lg:px-12 max-w-[1440px]">
        {/* Header Module */}
        <div className="relative mb-10 md:mb-40">
          <div className="relative grid gap-8 md:gap-16 lg:grid-cols-[1.3fr_1fr] lg:items-center z-10">
            {/* Left Content */}
            <motion.div
              initial="hidden"
              whileInView="visible"
              ...
              className="space-y-5 md:space-y-8 text-center lg:text-left relative z-10"
            >
              <motion.div
                variants={{
              ...
              <motion.h2
                ...
                className="text-4xl sm:text-5xl md:text-7xl lg:text-[84px] font-black tracking-tighter text-white leading-[1.05] md:leading-[1.0]"
              >
              ...
              <motion.p
                ...
                className="max-w-2xl mx-auto lg:mx-0 text-base md:text-2xl leading-relaxed md:leading-[1.6] text-[#8a9ba8] font-medium"
              >
            ...
            >
              ...
              <div className="relative h-full w-full rounded-2xl bg-[#0a1018]/95 backdrop-blur-3xl p-6 md:p-12">
                {/* Corner HUD elements */}
                ...
                <motion.div
                  ...
                  className="inline-flex items-center justify-center w-11 h-11 md:w-14 md:h-14 rounded-xl bg-[#39ff14]/10 mb-5 md:mb-8 border border-[#39ff14]/30 text-[#39ff14] shadow-[0_0_20px_rgba(57,255,20,0.15)]"
                >
                  <Sparkles className="size-6 md:size-7" />
                </motion.div>
                <h3 className="text-2xl font-bold text-white md:text-4xl mb-4 md:mb-6 leading-tight">
                  Per-change maintenance, without retainers
                </h3>
                <p className="text-sm md:text-xl leading-relaxed text-[#8a9ba8] mb-6 md:mb-10">
                ...
                <div className="grid gap-3 md:gap-4 grid-cols-2">
                  {[
                    ...
                    <motion.div
                      ...
                      className="flex items-center gap-2 md:gap-3 rounded-xl border border-white/[0.06] bg-[#080d12]/80 px-3 py-3 md:px-5 md:py-4 transition-all duration-300 cursor-default"
                    >
                      <ArrowRight className="size-4 text-[#39ff14] shrink-0" />
                      <span className="text-xs md:text-sm font-bold uppercase tracking-wider text-[#dae3ee]">
                        {item}
                      </span>
                    </motion.div>
                  ))}
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 md:gap-8 relative z-20">
