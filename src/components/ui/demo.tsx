  ...
  return (
    <footer className="bg-[#0a1414]/80 relative h-fit md:rounded-3xl overflow-hidden md:m-8 border-t md:border border-[#1d6b6b]/30 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto p-6 md:p-14 z-40 relative text-[#f2f2f2]">
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-8 md:gap-8 lg:gap-16 pb-8 md:pb-12">
          <div className="col-span-2 md:col-span-1 flex flex-col space-y-4 items-center md:items-start text-center md:text-left">
